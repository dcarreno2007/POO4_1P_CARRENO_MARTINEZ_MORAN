...
public class Compra {
    ...
    public Compra(TipoCompra tipoCompra, int codigoRef, String fechaCompra, int cantidad, double valorPagado, int codigoAficionado, Zona zona) {
        this.codigo = generarCodigo();
        this.tipo = tipoCompra;
        this.codigoReferencia = generarCodigo();
